    ...
    <>
      <div class="sidebar text-center">
        ...
        <div class="sidebar-group-2">
          <IoPersonCircle class="sidebar-profile sidebar-icons" />

          <RiSettings5Fill class="sidebar-settings sidebar-icons" />
        </div>
      </div>
